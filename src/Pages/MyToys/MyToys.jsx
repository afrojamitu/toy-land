...
const MyToys = () => {
    ...
    const url = `https://toy-land-server-beta.vercel.app/myToys?email=${user.email}`;
    ...
    const handleDelete = id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://toy-land-server-beta.vercel.app/myToys/${id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
